...
![1551873642007](E:\typora-document\MyNote\images\1551873642007.png)

ll .git/:查看隐藏文件内部文件；

![1551873839648](E:\typora-document\MyNote\images\1551873839648.png)
...
![1551872356867](E:\typora-document\MyNote\images\1551872356867.png)

ls -lA:将当前路径下所有资源（包含隐藏资源）全部罗列出来；

![1551872570026](E:\typora-document\MyNote\images\1551872570026.png)

ls -s|less:分屏查看上述罗列的资源（可以按Ctrl+z退出）；

cd  一个路径：进入这个路径；

![1551873080816](E:\typora-document\MyNote\images\1551873080816.png)

mkdir WeChat:在当前目录下创建一个名为WeChat的文件夹；

![1551873439290](E:\typora-document\MyNote\images\1551873439290.png)

ls lA|less:分屏罗列所有资源（包含隐藏资源）

![1551939435305](E:\typora-document\MyNote\images\1551939435305.png)
...
![1551938837933](E:\typora-document\MyNote\images\1551938837933.png)
...
![1551939564133](E:\typora-document\MyNote\images\1551939564133.png)
...
![1551941992581](E:\typora-document\MyNote\images\1551941992581.png)
...
![1551943272725](E:\typora-document\MyNote\images\1551943272725.png)
...
![1551945691939](E:\typora-document\MyNote\images\1551945691939.png)

:arrow_forward: 多屏控制方式：空格向下翻页，按b向上翻页，按q退出

:arrow_forward: git reset --hard 版本号：通过基于索引值的方式，将版本返回到过去或未来的某个版本

![1551947157664](E:\typora-document\MyNote\images\1551947157664.png)

![1551947515830](E:\typora-document\MyNote\images\1551947515830.png)

 :arrow_forward: git reset --hard HEAD^^：通过控制^的数量将版本返回过去的某个版本。返回后通过git log --oneline的方式将不能在查看未来的版本历史记录。

![1551948162498](E:\typora-document\MyNote\images\1551948162498.png)

:arrow_forward: git reset --hard HEAD~1:通过控制波浪线后的数字来控制返回到过去的某个版本。

![1551948474125](E:\typora-document\MyNote\images\1551948474125.png)
...
![1552011563480](E:\typora-document\MyNote\images\1552011563480.png)
...
![1552013385911](E:\typora-document\MyNote\images\1552013385911.png)

:black_flag: git checkout 分支名：切换分支

![1552013526328](E:\typora-document\MyNote\images\1552013526328.png)

:black_flag: git merge 分支名：合并分支

合并分支操作流程：首先需要切换到接收有新内容分支的分支--git checkout 负责接收的分支的名字，然后是这个分支接收有新内容分支--git merge 有新内容分支的名字。

![1552014492435](E:\typora-document\MyNote\images\1552014492435.png)

合并分支时，如果遇到冲突，会这样被标记出来：

![1552016089154](E:\typora-document\MyNote\images\1552016089154.png)

可在命令行时，在鼠标所在行敲d即可删除当前行。将内容修改完成后即可退出。通过git add 文件名，将冲突解决。但是此时合并未结束，需要提交到本地库才可以。通过git commit -m "修改消息或提示"即可结束合并。命令最后不可加入文件名。

![1552016619703](E:\typora-document\MyNote\images\1552016619703.png)
...
![1552030425593](E:\typora-document\MyNote\images\1552030425593.png)

:black_flag: git push origin master:将master分支推送到origin地址

![1552031292559](E:\typora-document\MyNote\images\1552031292559.png)

:black_flag: git clone github项目地址:将github上的项目克隆到本地的仓库

![1552031837564](E:\typora-document\MyNote\images\1552031837564.png)
...
![1552035095384](E:\typora-document\MyNote\images\1552035095384.png)

然后进入另一个地方：

![1552035176522](E:\typora-document\MyNote\images\1552035176522.png)
...
![1552356505435](E:\typora-document\MyNote\images\1552356505435.png)

勾选后，页面会变化，如下：

![1552356578010](E:\typora-document\MyNote\images\1552356578010.png)
...
![1552357017102](E:\typora-document\MyNote\images\1552357017102.png)
...
![1552357287579](E:\typora-document\MyNote\images\1552357287579.png)
...
![1552357744301](E:\typora-document\MyNote\images\1552357744301.png)
...
![1552357877562](E:\typora-document\MyNote\images\1552357877562.png)
...
![1552358152220](E:\typora-document\MyNote\images\1552358152220.png)
...
![1552358649740](E:\typora-document\MyNote\images\1552358649740.png)

点击途中红框处的add add branches spec，课件给所有分支选中添加到下方的框中，点击next,可编辑修改日志，如下：

![1552358781933](E:\typora-document\MyNote\images\1552358781933.png)
...
![1552359607103](E:\typora-document\MyNote\images\1552359607103.png)
...
![1552360239841](E:\typora-document\MyNote\images\1552360239841.png)
...
![1552361706285](E:\typora-document\MyNote\images\1552361706285.png)
...
![1552362149178](E:\typora-document\MyNote\images\1552362149178.png)

可通过右击>team>merge pool,结果如下：

![1552370845074](E:\typora-document\MyNote\images\1552370845074.png)
...
![1552372175314](E:\typora-document\MyNote\images\1552372175314.png)

点击remote tracking,将本地库没有的分支选中，点击下方的check out,然后选择如下：

![1552372253798](E:\typora-document\MyNote\images\1552372253798.png)
